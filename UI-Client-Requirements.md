...
The MCP Host supports multiple model providers (HuggingFace, OpenAI, Anthropic) and MCP servers (WebScraper, SearchEngine). If the server configuration exposes provider selection to clients, the UI should:
